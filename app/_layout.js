  ...
  return (
    <SafeAreaProvider>
      ...
      >
        ...
        {/* --- 보호자 관련 화면 --- */}
        <Stack.Screen
          name="guardian/GuardianScreen"
          options={{ title: "사용자 위치 확인" }}
        />
        <Stack.Screen
          name="guardian/AccountLinkScreen"
          options={{ title: "연동 관리" }}
        />
        <Stack.Screen
          name="guardian/GuardianSettingsScreen"
          options={{ title: "설정" }}
        />

        {/* --- 지도 관련 화면 --- */}
        <Stack.Screen
          name="map/MapGuardian"
          options={{ title: "사용자 위치 확인" }}
        />
        <Stack.Screen
          name="map/MapUser"
          options={{ title: "내 카트 위치 확인" }}
        />

        {/* --- 사용자 관련 화면 --- */}
        <Stack.Screen
          name="user/DeviceSettingsScreen"
          options={{ title: "기기 설정" }}
        />
        <Stack.Screen
          name="user/UserAccountScreen"
          options={{ title: "사용자 계정" }}
        />
        <Stack.Screen
          name="user/UserSettingsScreen"
          options={{ title: "설정" }}
        />

        {/* 동적 경로 화면 (예: 기기 상세 정보) */}
        <Stack.Screen
          name="user/[deviceId]/index"
          options={{ title: "기기 상세 설정" }}
        />
      </Stack>
    </SafeAreaProvider>
  );
